...
<div class="col-sm-2 clearfix vcenter" style="margin: 0 50px 0 0px;">
<img src="{{ site.url }}{{ site.baseurl }}/images/logopic/sls_logotiff.gif" style="width: 180px">
</div>

<div class="col-sm-2 clearfix vcenter" style="margin: 0 50px 0 0px;">
<img src="{{ site.url }}{{ site.baseurl }}/images/logopic/Brostcancerforbundet.png" style="width: 180px">
</div>
