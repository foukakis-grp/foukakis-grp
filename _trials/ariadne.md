...
ARIADNE ([NCT05900206](https://clinicaltrials.gov/study/NCT05900206)) is an academic, international, open label, randomized, comparative phase IIB trial, conducted in five countries (Sweden, Norway, Italy, Belgium and Netherlands). Study co-PIs are Theodoros Foukakis and Alexios Matikas. 
A total of 370 patients will be enrolled (current inclusion, February 2026: 118). Patients with non-metastatic HER2-positive BC are randomized 1:1 and stratified per country to receive either i) standard neoadjuvant TCHP (docetaxel, carboplatin, trastuzumab, pertuzumab) for three cycles or ii) trastuzumab deruxtecan for three cycles. Further treatment is based on the intrinsic molecular subtype by Prosigna (PAM50) assay (baseline sample):
...
<img src="{{ site.baseurl }}/images/trials/ariadne.jpg"
     alt="ARIADNE trial overview"
